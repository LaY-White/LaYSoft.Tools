...
{
    internal class OracleHelper : DBHelper
    {
        ...
        public override string ConnString
        {
            ...
            get
            {
                ...
                {
                    return DBClassTools.GetConnString(DBTypeEnum.Oracle, ConnectionArgModel);
                }
                return _ConnString;
            }
        }
        ...
        private OracleCommand MyCmd;
        private OracleConnection MyConn;
        private OracleTransaction MyTran;
        private OracleDataAdapter MyAdp;
        ...
        public override int ExecuteNonQuery(CommandType cmdType, string strSql, List<LaYSoftParameter> Pa)
        {
            ...
            {
                foreach (OracleParameter parm in cmdParameters)
                {
            ...
            catch (OracleException ex)
            {
                ...
                ErrStr = ex.Message;
                //写入日志
                DBClassTools.WriteSqlLog("Oracle", strSql, ex.Message);
        ...
        public override DataTable ExecuteDataTable(CommandType cmdType, string strSql, List<LaYSoftParameter> Pa)
        {
            ...
            try
            {
                MyAdp = new OracleDataAdapter(MyCmd);
                MyAdp.Fill(dt);
                Pa = LaYSoftParameter.GetLaYSoftParameter(MyCmd.Parameters);
