...
{
    internal class AccseeHelper : DBHelper
    {
        ...
        public override string ConnString
        {
            ...
            get
            {
                ...
                {
                    return DBClassTools.GetConnString(DBTypeEnum.Access, ConnectionArgModel);
                }
                return _ConnString;
            }
        }
        ...
        private OleDbTransaction MyTran;
        private OleDbDataAdapter MyAdp;
        ...
        {
            OleDbParameter[] cmdParameters = LaYSoftParameter.GetOleDbParameter(Pa);
            if (!SuerConnOpen())
            { Open(); }
            ...
            {
                foreach (OleDbParameter parm in cmdParameters)
                {
            ...
            catch (OleDbException ex)
            {
                ...
                ErrStr = ex.Message;
                //写入日志
                DBClassTools.WriteSqlLog("Access", strSql, ex.Message);
